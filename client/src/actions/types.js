...
// Board
export const FETCH_BOARD_POSTS_SUCCESS = 'FETCH_BOARD_POSTS_SUCCESS';
export const FETCH_BOARD_POSTS_FAIL = 'FETCH_BOARD_POSTS_FAIL';
export const FETCHING_BOARD_POSTS = 'FETCHING_BOARD_POSTS';
